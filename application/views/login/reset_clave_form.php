...
<table>
	<tr>
		<td><?php echo form_label('Nueva Clave', $new_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label('Confirmar Nueva Clave', $confirm_new_password['id']); ?></td>
...
<?php echo form_submit('change', 'Cambiar Clave'); ?>
<?php echo form_close(); ?>
